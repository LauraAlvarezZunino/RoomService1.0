...
class VistaUsuario
{
      ...
      //  $habitacionesGestor->cargarDesdeJSON();
        ...
        switch ($opcion) {
            ...
            case 2:
                ...
                $this->dniGuardado = $dni;
                $usuario = $usuariosGestor->obtenerUsuarioPorDni($dni);
                if ($usuario) {
                    $this->menuUsuarioRegistrado($usuario, $habitacionesGestor, $reservasGestor);
                } else {
    ...
    private function menuUsuarioRegistrado($usuario, $habitacionesGestor, $reservasGestor)
    {
        while (true){
