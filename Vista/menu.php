...
{
    $usuariosGestor = new UsuarioControlador(); // Clase para manejar usuarios
    $habitacionesGestor = new HabitacionControlador(); // Clase para manejar habitaciones
    $reservasGestor = new ReservaControlador($habitacionesGestor); // Clase para manejar reservas
...
mostrarDatosUsuario($usuariosGestor);
---------------------------------------------------------------------------
